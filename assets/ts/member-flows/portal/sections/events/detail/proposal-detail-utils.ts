import type { FormDetailField } from "../types";
...
export function formatProposalAnswerValue(value: unknown, field?: FormDetailField): ProposalAnswerRow["values"] {
...
export function buildProposalAnswerRows(
  ...
  fields: FormDetailField[] | null | undefined,
): ProposalAnswerRow[] {
