    ...
    <div>
      {stats && (
        <div class="adm-mini-stats mb-3">
          <span class="adm-mini-stat"><strong class="text-success">{confirmed}</strong> confirmed</span>
          {waitlisted > 0 && <span class="adm-mini-stat"><strong class="text-info">{waitlisted}</strong> waitlisted</span>}
          {pendingConfirmation > 0 && <span class="adm-mini-stat"><strong class="text-warning">{pendingConfirmation}</strong> pending</span>}
          <span class="adm-mini-stat"><strong>{total}</strong> total</span>
