...
import type { AdminDueWorkRow, AdminDueWorkTab } from "../../../../shared/schemas/admin-due-work";
...
export function DueWorkTable({
  ...
  const columns: Column<AdminDueWorkRow>[] = [
    {
      header: "Type",
  ...
  return (
    <div class="mt-4">
      <div class="border rounded p-3">
        ...
        <ApiDataTable
          endpoint="/api/v1/admin/due-work"
          responseSchema={adminDueWorkListResponseSchema}
