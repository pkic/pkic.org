...
export const sponsorshipResponseSchema = z.object({ sponsorship: sponsorshipSchema });
...
export const SPONSORSHIP_SORT_COLUMNS = [
  "company",
  "eventName",
  "tier",
  "pipelineStage",
...
export const sponsorshipsListQuerySchema = listQuerySchema(SPONSORSHIP_SORT_COLUMNS).extend({
...
export const sponsorshipsListRouteSchema = {
  tags: ["Sponsorships"],
  summary: "List sponsorships (staff sales pipeline)",
...
export const SPONSORSHIP_COMPANY_SORT_COLUMNS = ["label", "sponsorshipCount"] as const;

export const sponsorshipCompaniesListQuerySchema = listQuerySchema(SPONSORSHIP_COMPANY_SORT_COLUMNS).extend({
  type: sponsorTypeSchema.optional(),
  stage: sponsorshipPipelineStageSchema.optional(),
  tier: trimmedString(1, 100).optional(),
});
...
export type SponsorshipTierConfig = z.infer<typeof sponsorshipTierConfigSchema>;

export const sponsorshipTierConfigListResponseSchema = z.object({ tiers: z.array(sponsorshipTierConfigSchema) });
export const sponsorshipTierConfigResponseSchema = z.object({ tier: sponsorshipTierConfigSchema });
...
export const sponsorshipTierConfigListRouteSchema = {
  ...
  responses: {
    "200": {
      ...
      content: { "application/json": { schema: sponsorshipTierConfigListResponseSchema } },
    },
  },
};
...
export const sponsorshipTierConfigUpdateRouteSchema = {
  ...
  responses: {
    "200": {
      description: "Updated.",
      content: { "application/json": { schema: sponsorshipTierConfigResponseSchema } },
    },
