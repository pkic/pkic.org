...
- Keep E2E fixtures synthetic and self-contained: a fresh database may have no members, sponsors, or group roster. Drive labeled controls through visible labels, and match assertions to the current UI copy.
