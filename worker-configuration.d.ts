/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2f45d741f4ea7cd6da8b6a3b9049c7d3)
// Runtime types generated with workerd@1.20260401.1 2026-04-03 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./functions/router");
	}
	...
	interface LocalEnv {
		...
		IMAGES: ImagesBinding;
		ASSETS_PUBLIC: Fetcher;
		DEV_STATIC_ORIGIN: "http://127.0.0.1:13131";
		HUGO_VERSION: "0.160.0";
		DEFAULT_MIN_PROPOSAL_REVIEWS: "2";
		DEFAULT_REFERRAL_CODE_LENGTH: "7";
		DEFAULT_INVITE_LIMIT_PER_ATTENDEE: "50";
	...
	interface Env {
		...
		SENDGRID_API_BASE?: "https://api.sendgrid.com/v3/mail/send";
		SPEAKER_UPLOAD_DEADLINE_DAYS?: "21";
		STRIPE_PUBLISHABLE_KEY?: "pk_live_51TADczLT173BlQwOkLRjg7nIK7sX9gZJj4DAvD30X8mKpP3Zu3ksMmMk6GYE2moavKccbH3VBqCHDF09mAlny3kg00pZN2Ke0d" | "pk_test_51TADczLT173BlQwOCJAhV0Mf5xxJXJWG9VWkprhXUSJZTaYdqr5vJynipzUfCglU93cIoCBBNOkviwhOqQ3ZFPNk00cxzuEyMH";
		INTERNAL_SIGNING_SECRET: string;
		FEEDBACK_IDENTITY_SECRET_V1: string;
		SENDGRID_API_KEY: string;
		FROM_EMAIL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HUGO_VERSION" | "DEFAULT_MIN_PROPOSAL_REVIEWS" | "DEFAULT_REFERRAL_CODE_LENGTH" | "DEFAULT_INVITE_LIMIT_PER_ATTENDEE" | "WAITLIST_CLAIM_WINDOW_HOURS" | "MAGIC_LINK_TTL_MINUTES" | "MANAGE_TOKEN_TTL_HOURS" | "REMINDER_INTERVAL_DAYS" | "MAX_INVITE_REMINDERS" | "MAX_PRESENTATION_REMINDERS" | "SENDGRID_API_BASE" | "SPEAKER_UPLOAD_DEADLINE_DAYS" | "STRIPE_PUBLISHABLE_KEY" | "INTERNAL_SIGNING_SECRET" | "FEEDBACK_IDENTITY_SECRET_V1" | "SENDGRID_API_KEY" | "FROM_EMAIL" | "FROM_NAME" | "APP_BASE_URL" | "STRIPE_SECRET_KEY" | "EMAIL_BADGE_DELAY_SECONDS" | "DEV_STATIC_ORIGIN">> {}
}
