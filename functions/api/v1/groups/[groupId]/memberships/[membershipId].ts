...
import {
  groupMembershipEndRouteSchema,
  groupMembershipUpdateRouteSchema,
} from "../../../../../../assets/shared/schemas/route-contracts-groups";

export const GroupMembershipUpdate = openApiRoute(groupMembershipUpdateRouteSchema, async (c: AdminContext, data) => {
  ...
  return json(await updateGroupMembership(db, group.id, data.params.membershipId, admin, data.body));
});
