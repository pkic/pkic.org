...
export const EventsEventSlugSpeakerInvitesPost = openApiRoute(
  {
    tags: ["Events", "Invites"],
    summary: "Create speaker peer nominations",
    request: {
    ...
    responses: {
      "200": { description: "Speaker nominations were created or endorsed." },
      "400": { description: "Invalid nomination payload." },
      "401": { description: "Registration manage token required." },
      "403": { description: "The manage token is not valid for this event." },
      "429": { description: "Nomination limit exceeded." },
    },
  },
  onRequestPost,
);
