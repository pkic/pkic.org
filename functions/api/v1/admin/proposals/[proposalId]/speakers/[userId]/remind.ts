...
export async function onRequestPost(c: AdminContext): Promise<Response> {
  return sendAdminProposalReminder(c, "profile", c.req.param("userId"));
}

export const AdminProposalSpeakerRemindPost = openApiRoute(
  ...
  async (c: AdminContext, data: ValidatedData<typeof adminProposalSpeakerReminderRouteSchema>) =>
    sendAdminProposalReminder(c, "profile", data.params.userId, data.params.proposalId),
);
