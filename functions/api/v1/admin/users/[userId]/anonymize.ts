...
export async function onRequestPost(
  ...
  const result = await anonymizeAdminUser(requestDb(c), admin, data?.params.userId ?? c.req.param("userId"));
...
export const AdminUsersUserIdAnonymizePost = openApiRoute(adminUserAnonymizeRouteSchema, onRequestPost);
