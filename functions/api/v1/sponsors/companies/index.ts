/**
 * GET /api/v1/sponsors/companies — grouped, paginated company list for
...
export const SponsorCompaniesGet = openApiRoute(sponsorshipCompaniesListRouteSchema, async (c: AdminContext, data) => {
