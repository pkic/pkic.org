/**
 * PATCH /api/v1/sponsors/:id/stage — advance the sales pipeline
...
export const SponsorStageUpdate = openApiRoute(sponsorshipStageUpdateRouteSchema, async (c: AdminContext, data) => {
