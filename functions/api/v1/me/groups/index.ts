...
import { selfGroupsListRouteSchema } from "../../../../../assets/shared/schemas/route-contracts-me-groups";
...
export const MeGroupsGet = openApiRoute(selfGroupsListRouteSchema, async (c: AdminContext, data) => {
