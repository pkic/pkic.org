...
export interface MemberProvisionRepresentative {
  name: string;
  email: string;
  role?: string;
  links?: string[];
...
export interface MemberProvisionInput {
  ...
  memberSince: string;
  representatives: MemberProvisionRepresentative[];
...
export async function provisionMember(
  ...
  const members: MemberCapacitySummary[] = result.representatives.map((rep) => ({
