...
import type { EmailOutboxRow } from "../../../../assets/shared/schemas/email-outbox";
...
export async function buildEmailOutboxRows(db: DatabaseLike, rows: OutboxListRow[]): Promise<EmailOutboxRow[]> {
