...
-- Section: Shared payment ledger and immutable payment-event history.
--
...
-- Section: Membership workflow archival (issue 163)
-- Published policy remains immutable; archival only controls future selection.
-- Existing applications continue to reference and execute their pinned version.
CREATE TABLE membership_workflow_archives (
  version_id TEXT NOT NULL PRIMARY KEY REFERENCES membership_workflow_versions(id),
