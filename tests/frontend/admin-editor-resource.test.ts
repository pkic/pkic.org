...
import { useAdminEditorResource } from "../../assets/ts/admin/hooks/useAdminEditorResource";
...
describe("useAdminEditorResource", () => {
  it("loads server data into editable state and refreshes it", async () => {
    ...
    let resource: ReturnType<typeof useAdminEditorResource<string[]>> | undefined;
    function Harness() {
      resource = useAdminEditorResource<string[]>(fetcher, [], []);
      return null;
    }
