...
describe("OpenAPI schema generation", () => {
  ...
  it("mounts management contracts through their owning resource routers", () => {
    ...
    expect(spec.paths["/api/v1/membership/fees/{feeId}/sync"].post).toBeDefined();
    ...
    expect(spec.paths["/api/v1/donations/payments/stripe/webhook"]).toBeUndefined();
    expect(spec.paths["/api/v1/membership/payments/stripe/webhook"]).toBeUndefined();
    expect(spec.paths["/api/v1/sponsors/checkouts/stripe/events"]).toBeUndefined();
    expect(spec.paths["/api/v1/email/sendgrid/webhook"].post).toBeDefined();
    expect(spec.paths["/api/v1/webhooks/stripe"].post).toBeDefined();
