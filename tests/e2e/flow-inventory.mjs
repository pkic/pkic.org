...
export const FLOWS = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        id: "3.7",
        title: "A closed or cancelled event refuses a registration before the form is filled in",
        status: "gap",
        note: "event-registration-status-policy decides this and no journey walks it. Letting somebody complete a form for an event that closed is the failure worth catching, and it is a different case from a full day, which the waitlist absorbs.",
      },
      {
        id: "3.8",
