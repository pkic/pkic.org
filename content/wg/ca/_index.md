...
resources:
  - title: CA/Browser Forum
    ...
    description: The CA/Browser Forum develops industry guidelines for CAs and browser vendors.
  - title: Mozilla Root Store Policy
    url: https://wiki.mozilla.org/CA
    description: Mozilla's root store inclusion policy and CA compliance requirements.
  - title: Apple Root Certificate Program
    url: https://www.apple.com/certificateauthority/ca_program.html
    description: Apple's requirements and policies for CAs in the Apple root store.
  - title: Microsoft Trusted Root Program
    url: https://aka.ms/RootCert
    description: Microsoft's root certificate program requirements and guidelines.
---
